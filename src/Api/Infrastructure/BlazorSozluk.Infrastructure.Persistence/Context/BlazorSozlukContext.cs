...
namespace BlazorSozluk.Infrastructure.Persistence.Context
{
    ...
    {
        public const string DEFAULT_SCHEMA = "dbo";  //veritabanında bu şema kullanılacak
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(Assembly.GetExecutingAssembly());   //EntryConfigurationların EF'de otomatik olarak algılanması için assembly verildi 
        }
